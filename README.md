...
- PPO observation: density at 19 detectors + current demand + normalized time index + virtual ramp queue (22 features)
- Reward: negative spatial density standard deviation minus an on-ramp queue penalty
