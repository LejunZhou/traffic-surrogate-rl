"""Build the configurable SUMO network and route files.

The M14 scenario is a 2 km, one-lane freeway with a merge at 1300 m,
a 200 m ramp approaching at 10 degrees, and a 100 m acceleration lane.
netconvert is discovered on PATH or through SUMO_HOME.
"""
...
def build_network(output_dir: str, config: dict) -> dict[str, str]:
    """Generate SUMO network files for the configured scenario.
