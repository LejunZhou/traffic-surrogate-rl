...
u = r / ramp_discharge_vph (green fraction of the 1200 vph saturation
...
anywhere a policy path or `u=0.5` is accepted):
    ...
    optional extras: u0=0.5, umin=0, umax=1, cap=1200, qmax=100
"""
...
def make_controller(spec: str, env_cfg: dict | None = None) -> PIALINEAController:
    ...
    n_detectors, dt_ctrl_s, discharge = 19, 30.0, 1200.0
