"""
Evaluate trained policies and baseline controller specifications in SUMO.

Example: python scripts/eval_policy_profiles_sumo.py --policies u=0 u=0.5 u=1
         --set test --out runs/eval/constants_test.jsonl --workers 8
Use a local profile-set JSON path with --set to evaluate a smaller subset.
"""
...
def main() -> None:
    ...
    ap.add_argument("--overlay", default="configs/env_sumo.yaml")
    ...
    ap.add_argument("--network-dir", default="data/networks/eval")
    args = ap.parse_args()
